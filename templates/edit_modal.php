<div class="d-flex justify-content-center flex-wrap gap-2">
    ...
    <button type="button" class="btn btn-sm starred-btn">
    ...
    <button type="button" class="btn btn-sm">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16" data-bs-toggle="modal" data-bs-target="#editingModal">
